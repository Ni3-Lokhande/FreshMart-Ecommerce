...
const MyOrder = () => {
  ...
  return (
    ...
    <div className="card-img-overlay  mt-5" style={{ textAlign: "center" }}>
      ...
      <div className='nav-item nav-link active' style={{ fontSize: "35px", color: "white", marginTop: "150px" }}>ORDER HISTORY<br></br></div>
      <Link to="/" className='nav-item nav-link active' style={{fontSize:"20px" ,  color:"white"}}><i class="fas fa-home"></i>Home/View Orders</Link>
